...
class Solicitud(models.Model):
    ...
    tipo_persona = models.CharField(
        max_length=10, choices=TIPO_PERSONA_CHOICES)
...
class PersonaFisica(models.Model):
    ...
    solicitud = models.OneToOneField(
        Solicitud, on_delete=models.CASCADE, related_name='persona_fisica')
...
class PersonaMoral(models.Model):
    ...
    solicitud = models.OneToOneField(
        Solicitud, on_delete=models.CASCADE, related_name='persona_moral')
...
class RepresentanteLegal(models.Model):
    ...
    persona_moral = models.OneToOneField(
        PersonaMoral, on_delete=models.CASCADE, related_name='representante')
...
class Domicilio(models.Model):
    ...
    solicitud = models.ForeignKey(
        Solicitud, on_delete=models.CASCADE, related_name='domicilios')
...
class Vehiculo(models.Model):
    ...
    solicitud = models.OneToOneField(
        Solicitud, on_delete=models.CASCADE, related_name='vehiculo')
